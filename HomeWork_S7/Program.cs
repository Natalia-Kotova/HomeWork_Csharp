...
/* Решение задачи через создание нового одномерного массива со значениями среднего каждого столбца  */
...
// double[] FindMeanOnColumnsArray(int[,] array)
// {
//     double sumDigitsColumn = 0;
//     double meanDigitsColumn = 0;
//     double[] MeanArray = new double[array.GetLength(1)];  // цикл этого массива пойдет по k
//     int k = 0;
//     for (int j = 0; j < array.GetLength(1); j++)
//     {
//         for (int i = 0; i < array.GetLength(0); i++)
//         {
//             sumDigitsColumn += array[i, j];
//         }
//         meanDigitsColumn = sumDigitsColumn / array.GetLength(0);
//         MeanArray[k] = meanDigitsColumn;
//         sumDigitsColumn = 0;
//         k++;
//     }
//     return MeanArray;
...
// void PrintMeansOnColumsArray(double[] matrix)
// {
//     for (int i = 0; i < matrix.Length; i++)
//     {
//         System.Console.Write($"{matrix[i]:f2}\t");
//     }
//     System.Console.WriteLine();
// }
...
// int[,] myArray = GenerateArray(rowsOnArray, columnsOnArray);
// PrintArray(myArray);
// double[] newArray = FindMeanOnColumnsArray(myArray);
// PrintMeansOnColumsArray(newArray);
